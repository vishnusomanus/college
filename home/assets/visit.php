...
$e_body = "You have been contacted by $name_visit $lastname_visit with a request to visit the campus with the following date:" . PHP_EOL . PHP_EOL;
...
$usermessage = "Thank you for contact PMSA. We will reply shortly!";
