											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="number" min="1000000000" max="9999999999" name="phone_no" class="form-control"placeholder="Enter Mobile Number">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
