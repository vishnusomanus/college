								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <input type="number" name="mobile_no"  min="1000000000" max="9999999999" class="form-control" required>
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
									...
									<form action="search_student.php" method="post">
										<div class="form-group">
											<label for="exampleInputPassword1"><h5>Search:</h5></label>
														<div class="d-flex">
												<select class="browser-default custom-select" name="search">
													<option >Select Student</option>
													<?php
													$query="select roll_no,	first_name,	middle_name, last_name from student_info";
													$run=mysqli_query($con,$query);
													while($row=mysqli_fetch_array($run)) {
													echo	"<option value=".$row['roll_no'].">".$row['first_name'].' '.$row['middle_name'].' '.$row['last_name']."</option>";
													}
												?>
												</select>
							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
										...
										<?php 
											if($profile_image == "") $profile_image = "icbs_logo.png"
										?>
