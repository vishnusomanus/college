					...
					<div class="col-md-12 ml-2">
						<section class="border mt-3">
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								$i=1;
									...
									?>
										...
										<tr>
											...
											<?php $query1="select count(attendance_id) as attendance_id,SUM(attendance) as attendance from teacher_attendance  where teacher_id='$teacher_id'";
                                                $run1=mysqli_query($con, $query1);
                                                //print_r($query1);
                                                while ($row1=mysqli_fetch_array($run1)) { ?>
												<td><?php echo $row1['attendance'] ?></td>
											<td><?php echo ($row1['attendance_id'] - $row1['attendance']) ?></td>
											<td class="text-center"><?php echo $row1['attendance_id'] ?></td>
								...
								?>
								<input type="submit" name="sub" class="btn btn-dark">
